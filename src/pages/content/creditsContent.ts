...
export const DISCLAIMER_HTML: string = [
  ...
  '<br><br>',
  '<a href="https://github.com/thecreazy/invader-tony" target="_blank" rel="noopener">GITHUB \u2014 VIENI A GUARDARE</a>',
  '<br><br>',
  'VUOI LA BIRRA?',
  'SCRIVIMI:',
  '<br><br>',
  '<a href="https://www.linkedin.com/in/riccardocanella/" target="_blank" rel="noopener">LINKEDIN</a>',
  '<br>',
  '<a href="https://www.instagram.com/thecrz/" target="_blank" rel="noopener">INSTAGRAM</a>',
  '<br><br>',
  'TI PREGU COMP\u00C0,',
  'NON MI DENUNCIARI... \uD83D\uDE4F',
].join('<br>');
...
export const PERSON_SCHEMA = {
  ...
  sameAs: [
    'https://github.com/thecreazy/invader-tony',
